...
{
    public class UnitTestMoviesApiController
    {
        [Fact]
        public void TestGetMoviesByCategoryAction()
        {
            ...
            MovieApiController movieApiController = new MovieApiController(mockMovieService.Object);
        ...
        public void TestSortMoviesByRatingsInGivenYearAction()
        {
            ...
            MovieApiController movieApiController = new MovieApiController(mockMovieService.Object);
            Assert.Same(movies, movieApiController.SortMoviesByRatingsInGivenYear(2021));
        }
    }
}
